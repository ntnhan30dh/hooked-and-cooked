...
const Sides = () => {
  ...
  return (
      ...
      <div className="slickWrap md:w-1/2 md:mr-10">
      <Slick >
        <MenuItem  pic="sides1"  />
        <MenuItem
          pic="sides1"
      ...
      <div className=" hidden md:block w-3/4 mx-auto">
        ...
        <div className="hidden md:block absolute md:top-0 md:left-0 w-1/5 ">
        ...
        <Plx parallaxData={parallaxRotate} className=" absolute top-0 md:top-3/5 right-0 md:right-auto md:left-1/5 w-1/3 md:w-1/6">
          <img src={sauceYellow} alt="sauceYellow" />
        </Plx>
        <Plx parallaxData={parallaxRotate} className=" hidden md:block absolute bottom-0 right-0 left-6 w-1/6">
        ...
        <div className=" hidden md:block absolute w-1/5 right-0 bottom-1/20">
